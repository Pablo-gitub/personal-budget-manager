...
\subsection{Paolo Pietrelli}
	...
	\subsubsection{JSON}
		...
		\\
		\begin{figure}[H]
                \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{img/OperationJsonFile.png}}%
                \caption{ER representation of the JSON file}
                \label{fig:my_label}
            \end{figure}
            \begin{figure}[H]
                \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{img/OperationJsonFileFinal.png}}%
